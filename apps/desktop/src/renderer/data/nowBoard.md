...
Later:
- Deploy plugin registry migration 0009 so `dripnex-plugin publish` persists.
...
- Mermaid viewport (pan / zoom / Expand).
- Showcase notes in Inbox.
- GitHub watchers pull issues into Inbox notes.
