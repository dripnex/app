...
export const OFFICIAL_THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: 'dripnex-glass',
    name: 'Glass',
    description: 'Frosted dark. The desktop shows through.',
    author: 'Dripnex',
    colorScheme: 'dark',
    pluginId: 'dripnex',
    tokens: {
      '--bg-base': 'rgba(10, 11, 16, 0.12)',
      '--bg-surface': 'rgba(16, 17, 24, 0.22)',
      '--bg-elevated': 'rgba(22, 24, 34, 0.28)',
      '--bg-inset': 'rgba(8, 9, 14, 0.16)',
      '--bg-hover': 'rgba(220, 220, 230, 0.08)',
      '--bg-active': 'rgba(220, 220, 230, 0.12)',
      '--text-primary': '#ececf1',
      '--text-secondary': 'rgba(236, 236, 241, 0.74)',
      '--text-muted': 'rgba(236, 236, 241, 0.5)',
      '--text-faint': 'rgba(236, 236, 241, 0.32)',
      '--border': 'rgba(255, 255, 255, 0.1)',
      '--border-subtle': 'rgba(255, 255, 255, 0.06)',
      '--border-strong': 'rgba(255, 255, 255, 0.16)',
      '--accent': '#7dd3fc',
      '--accent-hover': '#bae6fd',
      '--accent-muted': 'rgba(125, 211, 252, 0.18)',
      '--accent-subtle': 'rgba(125, 211, 252, 0.1)',
      '--glass-bg': 'rgba(16, 17, 24, 0.28)',
      '--glass-border': 'rgba(255, 255, 255, 0.1)',
      '--glass-bg-menu': 'rgba(28, 30, 40, 0.78)',
      '--glass-border-menu': 'rgba(255, 255, 255, 0.1)',
