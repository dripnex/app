/** Concrete English words for generated passphrases. Six picks ≈ 66 bits. */
export const PASSPHRASE_WORDS: readonly string[] = [
  'able', 'acid', 'acre', 'act', 'actor', 'adapt', 'add', 'admit', 'adopt', 'adult',
  'after', 'again', 'agent', 'agree', 'ahead', 'aim', 'air', 'alarm', 'album', 'alert',
  'alien', 'align', 'alike', 'alive', 'alley', 'allow', 'ally', 'almost', 'alone', 'along',
  'aloud', 'alpha', 'also', 'alter', 'always', 'amber', 'amend', 'among', 'amount', 'amuse',
  'anchor', 'ancient', 'angel', 'anger', 'angle', 'angry', 'animal', 'ankle', 'announce', 'annual',
  'answer', 'ant', 'anvil', 'any', 'apart', 'apex', 'apple', 'apply', 'apron', 'arch',
  'arena', 'argue', 'arise', 'armor', 'army', 'aroma', 'arrow', 'art', 'artist', 'ash',
  'aside', 'ask', 'asleep', 'aspect', 'asset', 'atlas', 'atom', 'attic', 'audio', 'audit',
  'august', 'aunt', 'author', 'auto', 'autumn', 'avenue', 'avoid', 'awake', 'award', 'aware',
  'away', 'awesome', 'axis', 'baby', 'back', 'bacon', 'badge', 'bag', 'bake', 'balance',
  'ball', 'bamboo', 'banana', 'band', 'bank', 'bar', 'barely', 'barn', 'barrel', 'base',
  'basic', 'basin', 'basket', 'batch', 'bath', 'battle', 'beach', 'bead', 'beam', 'bean',
  'bear', 'beard', 'beast', 'beat', 'beauty', 'become', 'bed', 'bee', 'beef', 'been',
  'before', 'begin', 'behave', 'behind', 'being', 'bell', 'below', 'belt', 'bench', 'bend',
  'benefit', 'berry', 'best', 'better', 'between', 'beyond', 'bicycle', 'bid', 'bike', 'bind',
  'biology', 'bird', 'birth', 'bit', 'bite', 'bitter', 'black', 'blade', 'blame', 'blank',
  'blast', 'blaze', 'blend', 'bless', 'blind', 'block', 'blood', 'bloom', 'blossom', 'blue',
  'bluff', 'board', 'boat', 'body', 'boil', 'bold', 'bolt', 'bomb', 'bond', 'bone',
  'bonus', 'book', 'boost', 'boot', 'border', 'bore', 'born', 'borrow', 'boss', 'both',
  'bottle', 'bottom', 'bounce', 'bound', 'bowl', 'box', 'boy', 'brain', 'brake', 'branch',
  'brand', 'brass', 'brave', 'bread', 'break', 'breed', 'breeze', 'brick', 'bridge', 'brief',
  'bright', 'bring', 'brisk', 'broad', 'broke', 'bronze', 'broom', 'brother', 'brown', 'brush',
  'bubble', 'bucket', 'buddy', 'budget', 'buffer', 'build', 'bulb', 'bulk', 'bullet', 'bunch',
  'bundle', 'bunker', 'burden', 'bureau', 'burn', 'burst', 'bus', 'bush', 'business', 'busy',
  'butter', 'button', 'buyer', 'cabin', 'cable', 'cactus', 'cage', 'cake', 'calf', 'call',
  'calm', 'camel', 'camera', 'camp', 'can', 'canal', 'cancel', 'candy', 'cannon', 'canoe',
  'canvas', 'canyon', 'cap', 'cape', 'capital', 'captain', 'car', 'carbon', 'card', 'care',
  'cargo', 'carpet', 'carry', 'cart', 'case', 'cash', 'casino', 'cast', 'casual', 'cat',
  'catch', 'category', 'cattle', 'caught', 'cause', 'cave', 'ceiling', 'celery', 'cell', 'cement',
  'census', 'center', 'cereal', 'certain', 'chair', 'chalk', 'champion', 'change', 'chaos', 'charge',
  'chase', 'chat', 'cheap', 'check', 'cheese', 'chef', 'cherry', 'chest', 'chicken', 'chief',
  'child', 'chimney', 'choice', 'choose', 'chunk', 'church', 'circle', 'citizen', 'city', 'civil',
  'claim', 'clamp', 'clap', 'clarify', 'claw', 'clay', 'clean', 'clerk', 'clever', 'click',
  'client', 'cliff', 'climb', 'clinic', 'clip', 'clock', 'close', 'cloth', 'cloud', 'clown',
  'club', 'clump', 'clutch', 'coach', 'coast', 'coat', 'cocoa', 'code', 'coffee', 'coil',
  'coin', 'cold', 'color', 'column', 'combat', 'combine', 'come', 'comfort', 'comic', 'common',
  'company', 'concert', 'conduct', 'confirm', 'congress', 'connect', 'consider', 'control', 'cook', 'cool',
  ...
  'danger', 'daring', 'dash', 'data', 'date', 'daughter', 'dawn', 'day', 'deal', 'debate',
  ...
  'ethics', 'evidence', 'evil', 'evoke', 'evolve', 'exact', 'example', 'exceed', 'excel', 'except',
