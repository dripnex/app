...
export default function NewsletterForm({ compact = false }: NewsletterFormProps) {
  ...
  // Compact variant: horizontal layout for footer
  if (compact) {
    return (
  ...
  // Full variant: centered card with heading/description
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-white/[0.06] bg-surface p-8 text-center">
      <h3 className="mb-2 text-xl font-semibold text-white">Stay in the loop</h3>
      <p className="mb-6 text-sm text-[#71717a]">
        Get updates on new features, tips, and early access to upcoming releases. No spam, ever.
      </p>
      ...
      <p className="mt-4 text-xs text-[#71717a]/60">
