    ...
    <>
      ...
      <Transition show={isOpen} as={Fragment}>
        <Dialog onClose={close} className="relative z-50">
          ...
          >
            <DialogPanel className="fixed inset-x-0 top-0 max-h-screen overflow-y-auto bg-zinc-950/95 backdrop-blur-xl border-b border-white/[0.06] shadow-2xl">
              {/* Header with close button */}
              <div className="flex items-center justify-between border-b border-white/[0.06] px-6 py-4">
                <DialogTitle className="font-mono text-lg font-bold text-zinc-50 tracking-tight">
