---
title: Storage
description: Storage architecture — SQLite, sync engine, migrations, and backup system
---
...
The `@dripnex/sync-core` package adds a sync layer on top of local storage:
...
See [Data Management](/docs/guide/getting-started#import--export).
