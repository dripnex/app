...
description: Significant architectural decisions made during Readied's development
---
...
| ADR                                                         | Title            | Status   |
| ----------------------------------------------------------- | ---------------- | -------- |
| [ADR-001](/docs/decisions/adr-001-runtime-contract) | Runtime Contract | Accepted |
| [ADR-002](/docs/decisions/adr-002-markdown-model)   | Markdown Model   | Accepted |
| [ADR-003](/docs/decisions/adr-003-storage)          | Storage Strategy | Accepted |
