...
description: Get up and running with Readied — installation, first launch, and key features
---
...
- Read the [Principles](/docs/guide/principles) to understand the philosophy
- Explore the [Architecture](/docs/architecture/overview) to understand how it works
- Check the [ADRs](/docs/decisions) for key technical decisions
