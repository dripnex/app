...
[![CI Status](https://github.com/tomymaritano/readide/actions/workflows/ci.yml/badge.svg)](https://github.com/tomymaritano/readide/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/tomymaritano/readide?label=latest)](https://github.com/tomymaritano/readide/releases/latest)
