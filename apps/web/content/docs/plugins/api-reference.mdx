---
title: API Reference
description: Complete reference for the Readied plugin API — PluginContext, EditorAPI, LayoutManager, and more
---
...
Access via `context.layout`. See [Layout Zones](/docs/plugins/layout-zones) for zone details.
